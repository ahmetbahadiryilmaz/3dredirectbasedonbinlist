...
$binler = "413226,10,T.C. ZİRAAT BANKASI A.Ş.,VISA,PLATINUM
...
512440,10,T.C. ZİRAAT BANKASI A.Ş.,MASTERCARD, BUSINESS
...
526911,12,T. HALK BANKASI A.Ş.,MASTERCARD,CLASSIC,virtual
537500,12,T. HALK BANKASI A.Ş.,MASTERCARD,CLASSIC,virtual
...
516840,46,AKBANK T.A.Ş.,MASTERCARD,GOLD
...
526955,62,T. GARANTİ BANKASI A.Ş.,MASTERCARD,Bonus
...
$binlerbankaisim=[];
/*
foreach ($binler as  $bin) {
    $bintemp=explode(",",$bin);
    $binlerbanka[$bintemp[0]]=$bintemp[1];
    $binlerbankaisim[$bintemp[1]]=$bintemp[2];
}*/
